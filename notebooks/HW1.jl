...
function create_bar()
	# your code here!
	return cat(repeat([0], 40), repeat([1], 20), repeat([0], 40), dims=1)
end
...
(value_as_color ∘ get_red).(philip_head)
...
# ╔═╡ cac41a38-2906-47b0-9fd4-cc299f3e7c69
function get_greens(image::AbstractMatrix)
	get_green.(image)
end

# ╔═╡ 196e9eab-3ef2-45dd-9f2e-96738f456dd4
function get_blue(pixel::AbstractRGB)
	pixel.b
end

# ╔═╡ b078783a-c4d3-4aca-80d1-4f9f651ec83e
...
function custom_filter(pixel::AbstractRGB)
	...
	return RGB(pixel.r * pixel.g, pixel.g * pixel.b, pixel.b * pixel.r)
end
...
# ╔═╡ ac00a79d-8024-4e6d-9ef2-97ef0889d48e
custom_filter(philip_head)
